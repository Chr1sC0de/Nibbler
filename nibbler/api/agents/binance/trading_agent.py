...
if __name__ == "__main__":
    ...
    # agent.close_all_sell_stop_orders()

    # result = agent.get_all_open_orders()
    # buys = agent.get_buy_orders()
    # sells = agent.get_sell_orders()
    # positions = agent.get_all_positions()
    # symbolPosition = agent.get_symbol_position()
    pass