from ...math import PolyfitSavgolFilter, find_max_from_gradients, ConstantPaddingSavgolFilter
...
class SavitzkyMax:
    ...
    def __call__(self, dohlcv):
        ...
        self.features = \
            find_max_from_gradients(filteredGrad) + len(desiredField) - len(clippedField)
